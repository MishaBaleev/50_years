...
import "./sortCard.css";
import base_information from "./img/base_information.png";
import triggers from "./img/triggers.png";
import productivity from "./img/productivity.png";
import characteristic from "./img/characteristic.png";
import weather from "./img/weather.png";
import zone from "./img/zone.png";
import time from "./img/time.png";
import norm from "./img/norm.png"
...
class SortCard extends Component{
    ...
    render(){
        return(
            <div className={"sortCard "+this.state.is_closing}>
